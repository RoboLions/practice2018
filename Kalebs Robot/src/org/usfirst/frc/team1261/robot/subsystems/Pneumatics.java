...
public class Pneumatics extends Subsystem {
	...
	DoubleSolenoid piston1 = RobotMap.pisto1;
	DoubleSolenoid piston2 = RobotMap.pisto2;
	...
	public void pistonOut() {
		RobotMap.pisto1.set(DoubleSolenoid.Value.kForward);
		RobotMap.pisto2.set(DoubleSolenoid.Value.kForward);
		//System.out.println("Pistons Out!");
	}
    
	public void pistonIn() {
		RobotMap.pisto1.set(DoubleSolenoid.Value.kReverse);
		RobotMap.pisto2.set(DoubleSolenoid.Value.kReverse);
		//System.out.println("Pistons In!");
	}
    
	public void pistonOff() {
		RobotMap.pisto1.set(DoubleSolenoid.Value.kOff);
		RobotMap.pisto2.set(DoubleSolenoid.Value.kOff);
