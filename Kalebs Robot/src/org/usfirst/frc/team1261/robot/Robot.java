...
import org.usfirst.frc.team1261.robot.commands.ExampleCommand;
...
//import org.usfirst.frc.team1261.robot.subsystems.ExampleSubsystem;
...
public class Robot extends TimedRobot {
	...
	public void robotInit() {
		//Open = false;
		// static isClawOpen = false;
		// checkClaw(&isClawOpen, &isWheel);
		// *** This is in Turn.java ***
		/**
		 * checkClaw(*clawFlag){
		 * 	clawFlag = true;
		 *  isWheelTurning;
	...
	public void teleopPeriodic() {
		//System.out.println(Manipulator.getBoomEncoder());
		if (!Paused) {
			Scheduler.getInstance().run();
		} else {
